...
module.exports = function(bp) {
  ...
  bp.hear({
    type: /message|text/i,
    text: /empresas|bancos|empresa|banco|institucion|instituciones/i
  }, (event, next) => {
    event.reply('#bancos')
  })
  ...
  bp.hear({
    type: /message|text/i,
    text: /cae|carga anual equivalente|carga equivalente|comparar|comparación/i
  }, (event, next) => {
    event.reply('#cae')
  })
  ...
  bp.hear({
    type: /message|text/i,
    text: /conviene|con ustedes|por qué|devolución|devuelven/i
  }, (event, next) => {
    event.reply('#conviene')
  })
